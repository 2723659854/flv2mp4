...
| **PHP 版本** | 8.4.3 (CLI，开启 JIT) | 8.1.24 (CLI，未开启 OPcache) |
| **OPcache** | `opcache.enable_cli=on`，`opcache.jit=on`，`opcache.jit_buffer_size=100M` | 未开启 |
...
| :--- | :--- |:----------------------| :--- |
| **FLV 重编码** | 28 秒 | **23 秒**              | **↓ 17.9%** |
| **MP4 重编码** | 29 秒 | **24 秒**              | **↓ 17.2%** |
| **HLS（mpegts + m3u8）** | 37 秒 | **31 秒**              | **↓ 16.2%** |
