...
class RTMPClient
{
	...
	protected function socketRead($length)
	{
		return $this->socket->read($length);
	}
	protected function socketWrite(RtmpStream $data, $n = -1)
	{
	 ...
	 * @return bool
	 */
	protected function sendPacket(RtmpPacket $packet)
	{
	...
	protected function handle_invoke(RtmpPacket $p)
	{
