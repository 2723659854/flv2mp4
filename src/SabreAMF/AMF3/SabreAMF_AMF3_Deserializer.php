...
use DateTime;
use Xiaosongshu\Flv2mp4\SabreAMF\SabreAMF_ByteArray;
use Xiaosongshu\Flv2mp4\SabreAMF\SabreAMF_Deserializer;
use Xiaosongshu\Flv2mp4\SabreAMF\SabreAMF_Externalized;
use Xiaosongshu\Flv2mp4\SabreAMF\SabreAMF_TypedObject;

/**
 * amf3的数据解码
 * @purpose SabreAMF_AMF3_Deserializer
 * @author yanglong
 */
class SabreAMF_AMF3_Deserializer extends SabreAMF_Deserializer
{
    ...
    public function readAMFData($settype = null)
    {
        ...
        switch ($settype) {
            ...
            case SabreAMF_AMF3_Const::DT_UNDEFINED  :
                return null;
            case SabreAMF_AMF3_Const::DT_NULL       :
                return null;
            case SabreAMF_AMF3_Const::DT_BOOL_FALSE :
                return false;
            case SabreAMF_AMF3_Const::DT_BOOL_TRUE  :
                return true;
            case SabreAMF_AMF3_Const::DT_INTEGER    :
                return $this->readInt();
            case SabreAMF_AMF3_Const::DT_NUMBER     :
                return $this->stream->readDouble();
            case SabreAMF_AMF3_Const::DT_STRING     :
                return $this->readString();
            case SabreAMF_AMF3_Const::DT_XML        :
                return $this->readString();
            case SabreAMF_AMF3_Const::DT_DATE       :
                return $this->readDate();
            case SabreAMF_AMF3_Const::DT_ARRAY      :
                return $this->readArray();
            case SabreAMF_AMF3_Const::DT_OBJECT     :
                return $this->readObject();
            case SabreAMF_AMF3_Const::DT_XMLSTRING  :
                return $this->readXMLString();
            case SabreAMF_AMF3_Const::DT_BYTEARRAY  :
