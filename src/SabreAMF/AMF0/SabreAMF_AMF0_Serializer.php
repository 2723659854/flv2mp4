...
use DateTime;
use Xiaosongshu\Flv2mp4\SabreAMF\AMF3\SabreAMF_AMF3_Serializer;
use Xiaosongshu\Flv2mp4\SabreAMF\AMF3\SabreAMF_AMF3_Wrapper;
use Xiaosongshu\Flv2mp4\SabreAMF\SabreAMF_ITypedObject;
...
/**
 * 这个是php和flash的写数据交互
 * @purpose SabreAMF_AMF0_Serializer
 * @author yanglong
 */
    ...
    public function writeAMFData($data, $forcetype = null)
    {
        ...
        if (is_null($forcetype)) {
            ...
            if (!$type && is_array($data)) {
                ...
                //if is assoc array set it to object
                if (is_assoc($data)) {
                    $data = (object)$data;
                    goto checkObj;
                }
