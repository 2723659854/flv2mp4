 ...
 * @command php puller.php http://127.0.0.1:8501/live/stream output.flv 0 --no-reconnect
 * @command php puller.php ws://127.0.0.1:8501/live/stream output.flv 0 --no-reconnect
