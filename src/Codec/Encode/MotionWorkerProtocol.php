...
final class MotionWorkerProtocol
{
    ...
    public static function batch(int $id, int $width, int $height, int $alignedWidth, int $alignedHeight, string $ref, array $blocks): string { return self::frame(serialize([$id,$width,$height,$alignedWidth,$alignedHeight,$ref,$blocks])); }
}
